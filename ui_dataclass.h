/********************************************************************************
** Form generated from reading UI file 'dataclass.ui'
**
...
#ifndef UI_DATACLASS_H
#define UI_DATACLASS_H
...
public:
    ...
    QLineEdit *enterData;
    QComboBox *dataComboBox_2;
    QComboBox *dataComboBox_1;
    QComboBox *comboBox;
    QLineEdit *answerData;
    QPushButton *delBtn;

    void setupUi(QDialog *DataClass)
    {
        if (DataClass->objectName().isEmpty())
            DataClass->setObjectName("DataClass");
        DataClass->resize(290, 435);
        DataClass->setStyleSheet(QString::fromUtf8("border-radius: 7px; \n"
"background-color: rgb(76, 76, 76);\n"
""));
        equalsBtn = new QPushButton(DataClass);
        equalsBtn->setObjectName("equalsBtn");
        equalsBtn->setGeometry(QRect(150, 351, 135, 80));
...
"}"));
        enterData = new QLineEdit(DataClass);
        enterData->setObjectName("enterData");
        enterData->setGeometry(QRect(160, 131, 91, 28));
        QFont font1;
        font1.setPointSize(10);
        enterData->setFont(font1);
        enterData->setStyleSheet(QString::fromUtf8("background-color: rgb(224, 224, 224);\n"
"color: rgb(0, 0, 0);"));
        dataComboBox_2 = new QComboBox(DataClass);
        dataComboBox_2->addItem(QString());
        dataComboBox_2->addItem(QString());
        dataComboBox_2->addItem(QString());
        dataComboBox_2->addItem(QString());
        dataComboBox_2->addItem(QString());
        dataComboBox_2->addItem(QString());
        dataComboBox_2->setObjectName("dataComboBox_2");
        dataComboBox_2->setGeometry(QRect(40, 221, 81, 28));
        dataComboBox_2->setStyleSheet(QString::fromUtf8("/* \320\241\321\202\320\270\320\273\320\270\320\267\320\260\321\206\320\270\321\217 \320\276\321\201\320\275\320\276\320\262\320\275\320\276\320\263\320\276 QComboBox */\n"
"QComboBox {\n"
"\n"
...
"}\n"
""));
        dataComboBox_1 = new QComboBox(DataClass);
        dataComboBox_1->addItem(QString());
        dataComboBox_1->addItem(QString());
        dataComboBox_1->addItem(QString());
        dataComboBox_1->addItem(QString());
        dataComboBox_1->addItem(QString());
        dataComboBox_1->addItem(QString());
        dataComboBox_1->setObjectName("dataComboBox_1");
        dataComboBox_1->setGeometry(QRect(40, 131, 81, 28));
        dataComboBox_1->setStyleSheet(QString::fromUtf8("/* \320\241\321\202\320\270\320\273\320\270\320\267\320\260\321\206\320\270\321\217 \320\276\321\201\320\275\320\276\320\262\320\275\320\276\320\263\320\276 QComboBox */\n"
"QComboBox {\n"
"\n"
"    border-radius: 7px;     /* \320\227\320\260\320\272\321\200\321\203\320\263\320\273\320\265\320\275\320\275\321\213\320\265 \321\203\320\263\320\273\321\213 */\n"
"         /* \320\222\320\275\321\203\321\202\321\200\320\265\320\275\320\275\320\270\320\271 \320\276\321\202\321\201\321\202\321\203\320\277 */\n"
...
"}\n"
""));
        comboBox = new QComboBox(DataClass);
        ...
        comboBox->setGeometry(QRect(180, 11, 108, 22));
...
"}\n"
""));
        answerData = new QLineEdit(DataClass);
        answerData->setObjectName("answerData");
        answerData->setGeometry(QRect(160, 221, 91, 28));
        answerData->setFont(font1);
        answerData->setStyleSheet(QString::fromUtf8("background-color: rgb(224, 224, 224);\n"
"color: rgb(0, 0, 0);"));
        delBtn = new QPushButton(DataClass);
        delBtn->setObjectName("delBtn");
        delBtn->setGeometry(QRect(10, 350, 135, 80));
...
"}"));
    ...
    {
        DataClass->setWindowTitle(QCoreApplication::translate("DataClass", "Dialog", nullptr));
        equalsBtn->setText(QCoreApplication::translate("DataClass", "=", nullptr));
        dataComboBox_2->setItemText(0, QCoreApplication::translate("DataClass", "\320\221", nullptr));
        dataComboBox_2->setItemText(1, QCoreApplication::translate("DataClass", "\320\232\320\221", nullptr));
        dataComboBox_2->setItemText(2, QCoreApplication::translate("DataClass", "\320\234\320\221", nullptr));
        dataComboBox_2->setItemText(3, QCoreApplication::translate("DataClass", "\320\223\320\221", nullptr));
        dataComboBox_2->setItemText(4, QCoreApplication::translate("DataClass", "\320\242\320\221", nullptr));
        dataComboBox_2->setItemText(5, QCoreApplication::translate("DataClass", "\320\237\320\221", nullptr));

        dataComboBox_1->setItemText(0, QCoreApplication::translate("DataClass", "\320\221", nullptr));
        dataComboBox_1->setItemText(1, QCoreApplication::translate("DataClass", "\320\232\320\221", nullptr));
        dataComboBox_1->setItemText(2, QCoreApplication::translate("DataClass", "\320\234\320\221", nullptr));
        dataComboBox_1->setItemText(3, QCoreApplication::translate("DataClass", "\320\223\320\221", nullptr));
        dataComboBox_1->setItemText(4, QCoreApplication::translate("DataClass", "\320\242\320\221", nullptr));
        dataComboBox_1->setItemText(5, QCoreApplication::translate("DataClass", "\320\237\320\221", nullptr));

        comboBox->setItemText(0, QCoreApplication::translate("DataClass", "\320\224\320\260\320\275\320\275\321\213\320\265", nullptr));
        comboBox->setItemText(1, QCoreApplication::translate("DataClass", "\320\224\320\273\320\270\320\275\320\260", nullptr));
        comboBox->setItemText(2, QCoreApplication::translate("DataClass", "\320\241\320\272\320\276\321\200\320\276\321\201\321\202\321\214", nullptr));
        comboBox->setItemText(3, QCoreApplication::translate("DataClass", "\320\241\320\272\320\270\320\264\320\272\320\260", nullptr));
        comboBox->setItemText(4, QCoreApplication::translate("DataClass", "\320\232\320\260\320\273\321\214\320\272\321\203\320\273\321\217\321\202\320\276\321\200", nullptr));
        comboBox->setItemText(5, QCoreApplication::translate("DataClass", "\320\222\320\260\320\273\321\216\321\202\320\260", nullptr));
        comboBox->setItemText(6, QCoreApplication::translate("DataClass", "\320\230\320\234\320\242", nullptr));
        comboBox->setItemText(7, QCoreApplication::translate("DataClass", "\320\234\320\260\321\201\321\201\320\260", nullptr));
        comboBox->setItemText(8, QCoreApplication::translate("DataClass", "\320\236\320\261\321\212\320\265\320\274", nullptr));
        comboBox->setItemText(9, QCoreApplication::translate("DataClass", "\320\237\320\273\320\276\321\211\320\260\320\264\321\214", nullptr));
        comboBox->setItemText(10, QCoreApplication::translate("DataClass", "\320\242\320\265\320\274\320\277\320\265\321\200\320\260\321\202\321\203\321\200\320\260", nullptr));
        comboBox->setItemText(11, QCoreApplication::translate("DataClass", "\320\244\320\270\320\275\320\260\320\275\321\201\321\213", nullptr));

        delBtn->setText(QCoreApplication::translate("DataClass", "AC", nullptr));
    } // retranslateUi
